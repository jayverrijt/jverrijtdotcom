...
<div class="container">
    ...
    <div class="projectHolder" id="ph">
        ...
        <div class="pjHolder">
            <div class="pj1">
                <div class="infoBox" onclick="window.open('<?php echo e(route('welcome')); ?>')">
                    <!--GoodLookz-->
                    <h2>Good-Lookz</h2>
    ...
    <div class="hamburgerMenu" id="hm" style="display: none !important;">
        ...
        <div class="navItem">
            <a href="<?php echo e(route('welcome')); ?>"><p class="navItemP">Home</p></a>
        </div>
        <div id="item2" class="navItem">
            <a href="<?php echo e(route('projects.index')); ?>"><p class="navItemP">Projecten</p></a>
        </div>
        <div id="item3" class="navItem">
            <a href="<?php echo e(route('contact.index')); ?>"><p class="navItemP">Contact</p></a>
        </div>
    </div>
</div>
</body>
